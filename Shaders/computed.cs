...
{
    public class computeTest : BaseShaderEffect
    {
        // Film look tuning
        ...
        static computeTest _instance = new computeTest(); // auto-register

        public computeTest() : base("Compute Shader", "Cinematic film look with grain, vignette and scratches.") { }
